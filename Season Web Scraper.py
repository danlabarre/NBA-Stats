...
#engine = alc.create_engine('mysql+pymysql://root:@localhost:3306/NBA')
...
FEB = [str(x + 1) for x in range(20190200, 20190214)]  # Counts all games in February
